...
parser$add_argument("--comSCOREandUMIallele", type="character", help="PATH of UMIandSCORE alleleinfo file")
...
parser$add_argument("--comSCOREandUMIpairDist", type="character", help="PATH of UMI  oneCell Node pair tree dist file")
...
SCORE_result_list <- run_get_results(useArgs$SCOREallele, moreInfo, useArgs$SCOREpairDist, "bySCORE")
comSCOREandUMI_result_list <- run_get_results(useArgs$comSCOREandUMIallele, moreInfo, useArgs$comSCOREandUMIpairDist, "byCOM")

all_results <- list(SCORE_result=SCORE_result_list,
                    comSCOREandUMI_result=comSCOREandUMI_result_list)
